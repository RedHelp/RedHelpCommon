...
public class SaveBloodProfileResponse {
    
    private Long b_p_id;
    private CreateBloodProfileResponseTypes response_type;
    ...
    public CreateBloodProfileResponseTypes getResponse_type() {
        return response_type;
    }
    public void setResponse_type(CreateBloodProfileResponseTypes response_type) {
	...
	return "SaveBloodProfileResponse [b_p_id=" + b_p_id + ", response_type=" + response_type + ", u_id=" + u_id
	        + ", last_known_location_lat=" + last_known_location_lat + ", last_known_location_long="
	        + last_known_location_long + ", gender=" + gender + ", blood_group_type=" + blood_group_type
