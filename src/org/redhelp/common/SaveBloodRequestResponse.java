...
public class SaveBloodRequestResponse {
  //System related fields
    ...
    private Set<GetBloodProfileResponse> blood_request_receivers_profiles;
    ...
    public Set<GetBloodProfileResponse> getBlood_request_receivers_profiles() {
        return blood_request_receivers_profiles;
    }
    public void setBlood_request_receivers_profiles(Set<GetBloodProfileResponse> blood_request_receivers_profiles) {
	...
	return "SaveBloodRequestResponse [b_r_id=" + b_r_id + ", active=" + active + ", b_p_id=" + b_p_id
	        + ", creation_datetime=" + creation_datetime + ", patient_name=" + patient_name + ", list_blood_group=" + list_blood_group + ", blood_requirement_type="
	        + blood_requirement_type + ", description=" + description + ", units=" + units + ", phone_number="
	        + phone_number + ", blood_request_receivers_profiles=" + blood_request_receivers_profiles
